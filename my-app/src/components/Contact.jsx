    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10 mb-12">
        {contactDetails.map((item, i) => (
          ...
          >
            {item.icon}
            <h3 className="mt-5 text-lg sm:text-xl font-medium text-teal-700">{item.label}</h3>
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
        ...
        >
          ...
          <label className="block mb-4">
            ...
            <input
              type="text"
              className="w-full rounded-lg border border-neutral-300 px-4 py-3 shadow-sm placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition text-sm sm:text-base"
          ...
          <button
            type="submit"
            className="w-full flex justify-center items-center gap-3 bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-lg shadow-md transition text-base sm:text-lg"
          >
            <span>Submit</span>
