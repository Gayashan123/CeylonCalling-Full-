...
// Soft, simple, charm-inspired design: subtle color, soft shadow, rounded pills, clear focus, gentle animation
const SHOP_TYPES = [
  {
    key: "all",
    label: "All",
...
function ShopTypeFilter({ value, onChange }) {
  return (
    <section className="w-full mb-8 ">
      <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-5">Filter by Shop Type</h2>
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2
                rounded-full font-medium shadow
